...
def PlotStrainElls(ax_plus, ax_cross, ell, Mtot, dL, theta_jn, t_peak = None, phase=0, **kwargs):
	...
	ax_plus.plot(time, np.real(strain), **kwargs)
	ax_cross.plot(time, np.imag(strain), **kwargs)
...
strain_GR, time_GR, _ = PlotStrainElls(ax_plus, ax_cross, 0.0, Mtot, dL, 0, t_peak = t_peak, c='C0', label=r'$\ell=0$')
strain, time, _ = PlotStrainElls(ax_plus, ax_cross, 0.2, Mtot, dL, 0, t_peak = t_peak, c='C1', label=r'$\ell=0.2$')
strain_dCS, time_dCS, _ = PlotStrainElls(ax_plus, ax_cross, 0.3, Mtot, dL, 0, t_peak = t_peak, c='C2', label=r'$\ell=0.3$')
